...
class dicom_deidentifier_frame_gui(tkinter.Frame):
    ...
    def initialize(self):
        ...
        self.buttonSelect = tkinter.Button(self.frame,
                                   text=u"Select",
                                   command=self.askdirectory
                                  )
        self.buttonsPanel = tkinter.Frame(self.frame)

        self.entry.grid(row=0, column=0, padx=15, pady=10, sticky=tkinter.E + tkinter.W)
        ...
        self.buttonView = tkinter.Button(self.buttonsPanel,
                                 text=u"View DICOM fields",
                                 command=self.deidentify)
        self.buttonView.grid(row=0, column=0, padx=(0, 10), sticky=tkinter.E + tkinter.W)
        self.buttonView.configure(state=tkinter.DISABLED)

        self.messageView = tkinter.Label( self.frame,
    ...
    def askdirectory(self):
        ...
        self.buttonView.configure(state=tkinter.NORMAL)
        return self.dirname
    ...
    def deidentify(self):
        ...
        if len(field_dict) != 0:
            self.field_edit_win = tkinter.Frame(self.parent)
